export const translations = {
  // Navigation
  "nav.method": { nl: "Aanpak", en: "Method" },
  ...
  "method.usp2.text": { nl: "POCs in weken. Impact in maanden. Groot denken, klein starten.", en: "POCs in weeks. Impact in months. Think big, start small." },
  "method.usp3.title": { nl: "Mensgericht", en: "Human-centric" },
  "method.usp3.text": { nl: "Technologie is een middel. Uw people en processen staan centraal.", en: "Technology is a tool. Your people and processes are central." },
  ...
  // Partners
  "partners.label": { nl: "PARTNERSHIPS", en: "PARTNERSHIPS" },
  "partners.title": { nl: "Onze Partners", en: "Our Partners" },
  ...
  "cookie.privacy": { nl: "Privacybeleid", en: "Privacy Policy" },
  "cookie.policy": { nl: "Cookiebeleid", en: "Cookie Policy" }
};
